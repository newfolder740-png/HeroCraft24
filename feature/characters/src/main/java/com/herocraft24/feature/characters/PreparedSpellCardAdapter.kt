...
class PreparedSpellCardAdapter(
    private val onItemClick: (SpellSummary) -> Unit,
    private val onRemoveClick: (SpellSummary) -> Unit
) : RecyclerView.Adapter<PreparedSpellCardAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.binding.actionButton.setOnClickListener { onRemoveClick(spell) }
